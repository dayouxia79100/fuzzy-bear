 ...
 * Original file: /Users/dayouxia/Desktop/fuzzy-bear/LoL-Chat/app/src/main/aidl/com/rei/lolchat/service/aidl/IXmppFacade.aidl
 */
package com.rei.lolchat.service.aidl;
public interface IXmppFacade extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.rei.lolchat.service.aidl.IXmppFacade
{
private static final java.lang.String DESCRIPTOR = "com.rei.lolchat.service.aidl.IXmppFacade";
...
/**
 * Cast an IBinder object into an com.rei.lolchat.service.aidl.IXmppFacade interface,
 * generating a proxy if needed.
 */
public static com.rei.lolchat.service.aidl.IXmppFacade asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.rei.lolchat.service.aidl.IXmppFacade))) {
return ((com.rei.lolchat.service.aidl.IXmppFacade)iin);
}
return new com.rei.lolchat.service.aidl.IXmppFacade.Stub.Proxy(obj);
}
...
com.rei.lolchat.service.aidl.IXmppConnection _result = this.createConnection();
...
{
data.enforceInterface(DESCRIPTOR);
com.rei.lolchat.service.UserInfo _result = this.getUserInfo();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.rei.lolchat.service.aidl.IXmppFacade
{
...
/**
     ...
     */
@Override public com.rei.lolchat.service.aidl.IXmppConnection createConnection() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.rei.lolchat.service.aidl.IXmppConnection _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_createConnection, _data, _reply, 0);
_reply.readException();
_result = com.rei.lolchat.service.aidl.IXmppConnection.Stub.asInterface(_reply.readStrongBinder());
}
finally {
_reply.recycle();
_data.recycle();
...
/**
     ...
     */
@Override public com.rei.lolchat.service.aidl.IRoster getRoster() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     ...
     */
@Override public com.rei.lolchat.service.aidl.IChatManager getChatManager() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public void sendPresencePacket(com.rei.lolchat.service.PresenceAdapter presence) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.rei.lolchat.service.UserInfo getUserInfo() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.rei.lolchat.service.UserInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getUserInfo, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.rei.lolchat.service.UserInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.rei.lolchat.service.aidl.IPrivacyListManager getPrivacyListManager() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
/**
     * Get the XmppConnection of the facade.
     */
public com.rei.lolchat.service.aidl.IXmppConnection createConnection() throws android.os.RemoteException;
/**
     * Get the roster of the user
     */
...
public void sendPresencePacket(com.rei.lolchat.service.PresenceAdapter presence) throws android.os.RemoteException;
/**
     * make a jingle audio call
     * @param jid the receiver id
     */
...
public com.rei.lolchat.service.UserInfo getUserInfo() throws android.os.RemoteException;
